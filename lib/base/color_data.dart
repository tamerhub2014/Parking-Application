...
Color accentColor = "#03a5ab".toColor();
...
getFontGreyColor(BuildContext context) {
  return getCurrentTheme(context).textTheme.bodyMedium!.color;
}
...
ThemeData getLightThemeData() {
  return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        bodyMedium: TextStyle(color: "#7C7C7C".toColor()),
...
ThemeData getDarkThemeData() {
  return ThemeData(
      ...
      // selectedRowCol/**/or: "#5E57FF".toColor(),
